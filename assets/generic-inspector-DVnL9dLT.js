import{x as r}from"./stdlib-aBcQoNak.js";import{R as s,d as u}from"./main-BvIeRv4f.js";const o=(l,e,a)=>{const t=l.config?.[e];if(t!==void 0)return t;const i=u.getNodeType(l.config.typeId);if(i&&i.inputs){const n=i.inputs.find(p=>p.name===e);if(n&&n.defaultValue!==void 0)return n.defaultValue}return a},c=(l,e,a)=>r`
...
`,f=l=>(e,a)=>r`
    ...
    `;export{f as createGenericInspector};
//# sourceMappingURL=generic-inspector-DVnL9dLT.js.map
