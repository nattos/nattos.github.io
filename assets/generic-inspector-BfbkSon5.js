import{x as r,R as s,d as u}from"./index-NSZ1S18S.js";const o=(l,e,a)=>{const t=l.config?.[e];if(t!==void 0)return t;const n=u.getNodeType(l.config.typeId);if(n&&n.inputs){const i=n.inputs.find(p=>p.name===e);if(i&&i.defaultValue!==void 0)return i.defaultValue}return a},c=(l,e,a)=>r`
...
//# sourceMappingURL=generic-inspector-BfbkSon5.js.map
